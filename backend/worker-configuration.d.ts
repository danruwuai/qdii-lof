/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1e76adca0292708e0d37da117bf3e92a)
...
interface __BaseEnv_Env {
	...
	PORT: string;
	HOST: string;
	REFRESH_INTERVAL_CN: string;
	REFRESH_INTERVAL_HK: string;
	REFRESH_INTERVAL_US: string;
	REFRESH_INTERVAL_PREMIUM: string;
	REFRESH_INTERVAL_STATUS: string;
	REFRESH_INTERVAL_NAV: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JISILI_COOKIE" | "DATABASE_URL" | "PORT" | "HOST" | "REFRESH_INTERVAL_CN" | "REFRESH_INTERVAL_HK" | "REFRESH_INTERVAL_US" | "REFRESH_INTERVAL_PREMIUM" | "REFRESH_INTERVAL_STATUS" | "REFRESH_INTERVAL_NAV">> {}
}
